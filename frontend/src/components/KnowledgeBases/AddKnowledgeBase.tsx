...
const AddKnowledgeBase = () => {
  ...
  const mutation = useMutation({
    mutationFn: (data: KnowledgeBaseCreate) =>
      KnowledgeBasesService.createKnowledgeBase({ requestBody: data }),
    onSuccess: () => {
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Fill in the details to create a knowledge base.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Knowledge base name" type="text" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
